...
/**
 * 로고·날씨/날짜/시간·사용자(설정)·로그아웃을 헤더로 표시한다.
 */
export const TodoHeader = ({
  ...
  return (
    <header className="relative z-30 shrink-0 border-b border-border/80 bg-card/80 backdrop-blur-sm">
      <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-2 px-3 py-2 sm:gap-0 sm:px-6 sm:py-0 lg:h-16">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 sm:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] sm:h-16 sm:gap-4">
          <Dialog>
            <DialogTrigger
              render={
                <button
            ...
            {isAuthenticated ? (
              <>
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="shrink-0 rounded-2xl px-2 sm:px-3"
        ...
        <div className="min-w-0 sm:hidden">
          <HeaderClockWeather scheduledDates={scheduledDates} compact />
        </div>
      </div>
